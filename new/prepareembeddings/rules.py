...
from ..schemas.base_models import RelationInstance, RelProto
from ..utils.infos_loader import load_json_corpus
from ..utils.logger import logger
from .helper import build_encoders, encode_syntax, signed_weighted_jaccard, get_jdm_relations
